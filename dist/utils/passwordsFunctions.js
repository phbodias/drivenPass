...
function encryptPassword(password) {
    return __awaiter(this, void 0, void 0, function () {
        var saltRound, salt, crypt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    saltRound = Number(process.env.ENCRYPT_SALTS) || 20;
...
function comparePasswords(password, crypPassword) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1["default"].compare(password, crypPassword)];
                case 1:
...
function encryptString(password) {
    var _a;
    var cryptrKey = (_a = process.env.CRYPTR_PASSWORD) !== null && _a !== void 0 ? _a : "";
    var cryptr = new cryptr_1["default"](cryptrKey);
