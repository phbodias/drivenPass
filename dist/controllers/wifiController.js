...
var wifiServices = __importStar(require("../services/wifiServices"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wifiServices.createWifi(wifiData, userId)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wifiServices.wifiById(wifiId, userId)];
                case 1:
                    wifi = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userId = res.locals.userId;
                    return [4 /*yield*/, wifiServices.userWifis(userId)];
                case 1:
                    wifis = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wifiServices.deletewifi(id, userId)];
                case 1:
                    _a.sent();
