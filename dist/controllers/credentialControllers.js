...
var credentialServices = __importStar(require("../services/credentialsServices"));
function createCredential(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var credentialBody, userId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    credentialBody = req.body;
                    userId = res.locals.userId;
                    return [4 /*yield*/, credentialServices.createCredential(credentialBody, userId)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, credentialServices.credentialById(credentialId, userId)];
                case 1:
                    credential = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userId = res.locals.userId;
                    return [4 /*yield*/, credentialServices.userCredentials(userId)];
                case 1:
                    credentials = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, credentialServices.deleteCredential(id, userId)];
                case 1:
                    _a.sent();
