...
var wifisRepository = __importStar(require("../repositories/wifisRepository"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wifisRepository.insert(wifiData, userId)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function userWifis(userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wifisRepository.findByUserId(userId)];
                case 1:
                    wifis = _a.sent();
                    return [2 /*return*/, wifis.map(function (wifi) {
...
function deletewifi(id, userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wifiById(id, userId)];
                case 1:
                    wifi = _a.sent();
                    return [4 /*yield*/, wifisRepository.deleteOne(id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
