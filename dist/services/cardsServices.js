...
var cardsRepository = __importStar(require("../repositories/cardsRepository"));
...
function verifyCardLabelAvailable(userId, label) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cardsRepository.findByTitleAndUserId(userId, label)];
                case 1:
...
function createCard(cardData, userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, verifyCardLabelAvailable(userId, cardData.label)];
                case 1:
                    ...
                    return [4 /*yield*/, cardsRepository.insert(cardData, userId)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function userCards(userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cardsRepository.findByUserId(userId)];
                case 1:
                    cards = _a.sent();
                    return [2 /*return*/, cards.map(function (card) {
...
function deletecard(id, userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cardById(id, userId)];
                case 1:
                    card = _a.sent();
                    return [4 /*yield*/, cardsRepository.deleteOne(id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
