...
var credentialsRepository = __importStar(require("../repositories/credentialsRepository"));
...
function verifyCredentialLabelAvailable(userId, label) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, credentialsRepository.findByTitleAndUserId(userId, label)];
                case 1:
...
function createCredential(credentialData, userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, verifyCredentialLabelAvailable(userId, credentialData.label)];
                case 1:
                    ...
                    return [4 /*yield*/, credentialsRepository.insert(credentialData, userId)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function userCredentials(userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, credentialsRepository.findByUserId(userId)];
                case 1:
                    credentials = _a.sent();
                    return [2 /*return*/, credentials.map(function (credential) {
...
function deleteCredential(id, userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, credentialById(id, userId)];
                case 1:
                    credential = _a.sent();
                    return [4 /*yield*/, credentialsRepository.deleteOne(id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
